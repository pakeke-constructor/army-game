...
- squadOrder: This modifies the "order" that squads appear in the HUD. By default, buildings = -10, melee = 0, ranged = 10 - placement ordering is negative first, positive last. You MUST edit this if the unit benefits from being placed first/last, e.g. "when deployed, buff all allies." <-- this should be squadOrder = 50 or something. Alternatively, "Whenever an ally is spawned, earn $1", should be squadOrder = -30 to ensure it's FIRST.
